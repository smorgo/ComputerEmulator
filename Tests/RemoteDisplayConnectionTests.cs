...
namespace Tests
{
    public class RemoteDisplayConnectionTests
    {
        ...
        public RemoteDisplayConnectionTests()
        {
        ...
        private static void ConfigureServices(IServiceCollection services)
        {
            services
                 ...
                 .AddTransient<IDisplayHub, MockDisplayHubProxy>()
        ...
        [Test]
        public void CanCheckRemoteDisplayConnection()
        {
        ...
        [Test]
        public async Task CanClearRemoteDisplayConnection()
        {
            var connection = _serviceProvider.GetService<IRemoteDisplayConnection>();
        ...
        [Test]
        public async Task CanInitialiseRemoteDisplayConnection()
        {
            var connection = _serviceProvider.GetService<IRemoteDisplayConnection>();
        ...
        [Test]
        public async Task CanRenderToRemoteDisplayConnection()
        {
            var connection = _serviceProvider.GetService<IRemoteDisplayConnection>();
        ...
        [Test]
        public void CanControlDisplayViaMemoryMappedDisplayRemoteDisplayConnection()
        {
